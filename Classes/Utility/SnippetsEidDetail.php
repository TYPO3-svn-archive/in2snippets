...
class snippetsEidDetail {
	...
	*/
	public function __construct() {
		...
		$_POST['tx_in2snippets_pi1']['action'] = 'detailEid'; // set action
		$_POST['tx_in2snippets_pi1']['snippetSearch'] = $_GET['tx_in2snippets_pi1']['snippetSearch']; // set searchparam
...
$eid = t3lib_div::makeInstance('snippetsEidDetail'); // make instance
