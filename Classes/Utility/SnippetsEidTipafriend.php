...
class snippetsEidTipafriend {
	...
	*/
	public function __construct() {
		...
		$_POST['tx_in2snippets_pi1']['action'] = 'sendMail'; // set action
		$_POST['tx_in2snippets_pi1']['controller'] = 'Snippet'; // set controller
...
$eid = t3lib_div::makeInstance('snippetsEidTipafriend'); // make instance
