...
/**
 * Test case for class Tx_In2snippets_Controller_SnippetController.
 *
 * @version $Id$
 ...
 */
class Tx_In2snippets_Controller_SnippetControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
