	...
	'columns' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table_where' => 'AND tx_in2snippets_domain_model_code.pid=###CURRENT_PID### AND tx_in2snippets_domain_model_code.sys_language_uid IN (-1,0)',
			),
		),
		...
		'type' => array(
			'exclude' => 0,
			'label' => 'LLL:EXT:in2snippets/Resources/Private/Language/locallang_db.xml:tx_in2snippets_domain_model_code.type',
			'config' => array(
				'type' => 'select',
				'items' => array(
					array('', ''),
		...
		'code' => array(
			'exclude' => 0,
			'label' => 'LLL:EXT:in2snippets/Resources/Private/Language/locallang_db.xml:tx_in2snippets_domain_model_code.code',
			'config' => array(
				'type' => 'text',
				'cols' => 40,
				'rows' => 15
